...
import { ChevronDown, ChevronRight, FileText, Code, Database, Shield, Bot, Users, Zap, Globe } from 'lucide-react'
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="lg:col-span-3">
          <div className="bg-klyn-medium/5 border border-klyn-beige/10 rounded-2xl p-8 min-h-[600px]">
            {renderContent()}
          </div>
        </motion.div>
      </motion.div>
